...
export class WrongAnswerRequestAppDto {
  ...
  @ValidateIf((o: WrongAnswerRequestAppDto) => o.type == QuestionType.MATCHING)
  ...
  @ValidateIf((o: WrongAnswerRequestAppDto) => o.type == QuestionType.INTERVIEW)
